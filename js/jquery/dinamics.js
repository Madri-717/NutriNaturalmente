...
function cambiarColorTexto() {
    var seccionIntro = document.getElementById('titulo');
...
function enviarCorreo() {
    ...
    cuerpo += "Objetivo: " + Array.from(document.getElementById('objetivo').selectedOptions).map(option => option.value).join(', ') + "\n";
